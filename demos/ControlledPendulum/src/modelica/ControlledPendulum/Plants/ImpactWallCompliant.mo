...
model ImpactWallCompliant
  /*
    Compliant impact wall for a 1-DOF pendulum angle q.

    - Wall at angle theta_wall.
    - Smooth penetration pen ≈ max(theta - theta_wall, 0) using a differentiable approximation
  ...
  */
  ...
  // Parameters
  parameter Real theta_wall(unit="rad") = 0 "Angular position of the wall";
