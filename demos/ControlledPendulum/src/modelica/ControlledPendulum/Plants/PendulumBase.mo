...
partial model PendulumBase
  // Parameters
  parameter Real m(unit="kg") = 1.0842960702239823 "Pendulum mass";
  parameter Real L(unit="m") = 0.18165085343803214 "Pendulum length";
  parameter Real J(unit="kg.m2") = 0.04422682215965719 "Moment of inertia about pivot";
