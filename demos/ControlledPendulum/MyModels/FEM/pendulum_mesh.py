from demos.ControlledPendulum.MyModels.FEM.pendulum_config import GeometryParameters, MeshParameters, SimulationParameters
from netgen.occ import MoveTo, Rectangle, Circle, Compound, Axis, X, Y, OCCGeometry
from ngsolve import Mesh

def build_mesh(geo_params: GeometryParameters, mesh_params: MeshParameters, with_contact: bool) -> Mesh:
        gp = geo_params
        mp = mesh_params
