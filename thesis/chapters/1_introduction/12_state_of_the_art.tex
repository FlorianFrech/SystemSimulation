...
Tools such as Dymola, SimulationX, and OpenModelica~\cite{fritzson_openmodelica_2005} provide solvers, graphical editors, and libraries based on the Modelica language and the Modelica Standard Library.
...
OpenSim is therefore relevant for human-device interaction, but its models usually require tool-specific integration in co-simulation workflows.
...
As a result, such models are usually integrated through custom wrappers or tool-specific interfaces, while direct \ac{FMU} export remains uncommon.
