...
\texttt{FMUComponent} maps FMI function calls to the component lifecycle, while \texttt{OpenSimComponent} and \texttt{FEMComponent} do the same for OpenSim and NGSolve, respectively.
