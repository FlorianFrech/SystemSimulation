...
This section addresses SR-11-03 and is the implementation counterpart of the algebraic-loop theory introduced in Section~\ref{sec:cosim_algebraic_loops}.
...
\end{equation}
which matches the fixed-point form of Section~\ref{sec:cosim_algebraic_loops} restricted to $\mathcal{L}$.
