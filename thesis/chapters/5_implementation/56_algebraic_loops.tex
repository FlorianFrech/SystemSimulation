...
\begin{figure}[H]
  ...
  \caption[Verification scenario for algebraic loops]{Verification scenario for algebraic loops. The dashed red rectangle marks the SCC node set $\mathcal{L}=\{\texttt{Inner}\}$. Wire routing is purely visual and does not indicate SCC membership.}
...
\end{lstlisting}
  \caption[IJCSA solver trace]{IJCSA solver trace for the algebraic-loop verification scenario.
