...
The hybrid algorithm calls \texttt{handle\_event(event\_names, t)} at event times (Section~\ref{sec:impl_hybrid}).
...
Components that do not participate in hybrid simulation inherit an empty default implementation.
...
\begin{table}[htbp]
  \centering
  \small
  \caption{Base-class invariants checked with lightweight mock components.}
