...
\begin{table}[!htbp]
  \centering
  \small
  \caption{Runtime roles of the main \texttt{CoSimComponent} methods.
...
\begin{figure}[btbp]
  ...
  \caption{Initialization sequence of \texttt{CoSimComponent}.
...
\begin{figure}[btbp]
  ...
  \caption{Delegation during a simulation step.
