...
\begin{figure}[t]
  ...
  \caption{Runtime switching sequence of the \texttt{MultiComponent} class for a positive macro step. The wrapper applies the switching guards, transfers state and cached inputs on an accepted switch, and then delegates the step to the active model.}
...
\begin{figure}[t]
  ...
  \caption{Two-mode integrator check for runtime mode switching.
