...
\begin{figure}[t]
    ...
    \caption{Class-level overview of the \texttt{System} abstraction in \syssimx{}.
...
\begin{table}[t]
  \centering
  \small
  \caption{Registration checks for signal connections, event connections, and lifecycle protection.}
