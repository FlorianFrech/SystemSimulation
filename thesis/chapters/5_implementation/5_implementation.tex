...
Section~\ref{sec:impl_wrappers} explains how \ac{FMI}, OpenSim, and finite-element models are adapted to this contract.
...
\input{chapters/5_implementation/54_system}
...
Together, these features form the executable basis for heterogeneous co-simulation scenarios with structural analysis, algebraic-loop resolution, hybrid event handling, and runtime model switching.
Chapter~\ref{chap:case_study} evaluates their combined use in the controlled-pendulum case study.
The focus therefore shifts from feature-level verification to system-level evidence for the intended application workflow.
