...
The performance benchmark showed that restricting \ac{FEM} execution to the contact-relevant part of the trajectory reduced the total median wall time by about \(1.6\times\) for the selected configuration.
...
The main contribution is an implementation architecture that combines heterogeneous simulation tools, dependency-aware orchestration, hybrid event handling, and runtime model switching between fidelity levels in one controlled co-simulation workflow.
