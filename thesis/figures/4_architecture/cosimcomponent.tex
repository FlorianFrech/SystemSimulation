...
\begin{tikzpicture}[
  ...
  arr/.style = {
    ...
    draw=Mahogany!85, line width=1.1pt,
  },
  % Dashed golden border: optional capability
  optbox/.style = {
    draw=Goldenrod, dashed, line width=1.5pt,
    rounded corners=3pt,
  },
  % Lifecycle step box (main phases)
  lifestep/.style = {
    fill=Mahogany!24, rounded corners=2pt,
...
\begin{pgfonlayer}{background}
  ...
  % ── Title ──────────────────────────────────────────────────────────────────
  \fill[TealBlue!75!black] (0,0) rectangle (13cm,-0.85cm);

  % ── Port Interface ─────────────────────────────────────────────────────────
  \fill[black!46] (0,-0.85cm) rectangle (13cm,-1.35cm);
  \fill[black!17] (0,-1.35cm) rectangle (13cm,-2.85cm);

  % ── Left: Lifecycle header + content ───────────────────────────────────────
  \fill[Mahogany!80]   (0,-2.85cm)    rectangle (5.5cm,-3.35cm);
  \fill[Mahogany!12]   (0,-3.35cm)    rectangle (5.5cm,-10.85cm);

  % ── Right: State Handling ──────────────────────────────────────────────────
  \fill[OliveGreen!78!black] (5.5cm,-2.85cm) rectangle (13cm,-3.35cm);
  \fill[OliveGreen!11]       (5.5cm,-3.35cm) rectangle (13cm,-5.85cm);
  % Physical State sub-fill (slightly darker, mandatory sub-box)
  \fill[OliveGreen!22] (5.65cm,-3.50cm) rectangle (9.10cm,-5.70cm);

  % ── Right: Structural Metadata ─────────────────────────────────────────────
  \fill[Plum!75!black] (5.5cm,-5.85cm) rectangle (13cm,-6.35cm);
  \fill[Plum!8]        (5.5cm,-6.35cm) rectangle (13cm,-8.35cm);

  % ── Right: Hybrid Capabilities ─────────────────────────────────────────────
  \fill[MidnightBlue!80] (5.5cm,-8.35cm) rectangle (13cm,-8.85cm);
  \fill[MidnightBlue!7]  (5.5cm,-8.85cm) rectangle (13cm,-10.85cm);

  % ── Column separator + outer border ────────────────────────────────────────
  \draw[black!28, line width=0.6pt] (5.5cm,-2.85cm) -- (5.5cm,-10.85cm);
  \draw[TealBlue!60!black, line width=1.3pt, rounded corners=4pt]
...
\draw[OliveGreen!60!black, line width=0.7pt, rounded corners=3pt]
...
\draw[optbox, fill=OliveGreen!22] (9.40cm,-3.50cm) rectangle (12.80cm,-5.70cm);
...
\draw[optbox, fill=Plum!18] (5.75cm,-6.55cm) rectangle (12.75cm,-8.20cm);
...
% ── Content (optional: dashed golden box) ────────────────────────────────────
\draw[optbox, fill=MidnightBlue!15] (5.75cm,-9.05cm) rectangle (12.75cm,-10.65cm);
