...
% ============================================================================
% Pendulum figure parameters (origin at hinge)
% ============================================================================
\def\L{4}       % rod length
\def\W{0.3}     % rod width
...
\begin{tikzpicture}
  ...
  % --------------------------------------------------------------------------
  % Support and primary body
  % --------------------------------------------------------------------------
  % Fixed support at hinge
  \draw[supportSurface] (-0.45,0.6) rectangle (0.45,0.8);
  ...
  % --------------------------------------------------------------------------
  % Reference (ghost) state and contact force
  % --------------------------------------------------------------------------
  ...
  % Contact force at theta = 0 (normal to wall, pointing right)
  \draw[->, very thick, green!50!black] (-\R,-\L) -- ++(1.2,0) node[below] {$F_C$};
  ...
  \node[left, font=\footnotesize\itshape] (walllabel) at (-\R-\wallW-0.3, -\L) {rigid wall};
  \draw[thin, gray] (walllabel.east) -- (-\R-\wallW, -\L);

  % --------------------------------------------------------------------------
  % Force decomposition at pendulum head
  % --------------------------------------------------------------------------
  ...
  \draw[->, very thick, black!60] (-1.2,-0.5) -- (-1.2,-1.5) node[right=2pt] {$g$};

  % --------------------------------------------------------------------------
  % Global angle/length annotations
  % --------------------------------------------------------------------------
  ...
  % --------------------------------------------------------------------------
  % Coordinate system overlay (topmost layer)
  % --------------------------------------------------------------------------
