...
%
% Illustrates the two variable types in a hybrid system at event time t_i:
%
%   x(t)  — continuous state
%             Evolves smoothly between events.  At a reset event the state
%             jumps instantaneously from x^-(t_i) to x^+(t_i).
%
%   q(t)  — discrete state
%             Piecewise constant; changes only at event times.
...
%  Piecewise constant; jumps only at event times.
% ===========================================================================
...
% Constant segment [t_i, t_{i+1}] and beyond  (new level after jump)
...
%  Smooth between events; reset at t_i causes instantaneous jump.
% ===========================================================================
...
% Dashed vertical connector: visualises the instantaneous reset
