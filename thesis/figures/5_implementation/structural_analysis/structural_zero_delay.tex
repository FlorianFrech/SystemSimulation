...
\begin{tikzpicture}
  ...
  %\draw[help lines, step=0.5] (-1,-1) grid (4,4);

  % SCC highlight (merge of panel c)
  \draw[sccbox] (\nodeSep-0.75cm,-0.75) rectangle (\nodeSep+0.75cm, \nodeSep+0.75cm);
  \node[text=red!70!black] at (1,\nodeSep/2) [anchor=west, font=\large\bfseries] {SCC};
  ...
  \draw[connection] (B) edge[bend left=20, "×2"{above}] (C);
