...
\newcommand{\arrowlegend}[1]{%
  \begin{scope}[shift={#1}]
    ...
    \node[anchor=west, font=\scriptsize] at (0.75,0) {direct feedthrough};
    \draw[->, thick, black] (3.3,0) -- (4.0,0);
    \node[anchor=west, font=\scriptsize] at (4.05,0) {connection};
  \end{scope}%
}

\begin{document}
\begin{tikzpicture}[>=Latex]
  \draw[help lines, step=0.5] (-0.5,-0.5) grid (7,5.5);
